...
class _FilterCrewsScreenState extends State<FilterCrewsScreen> {
  ...
  Future<void> _loadDefaultLocation() async {
    // For now, we'll just set some default location info
    // In a real implementation, this would load from user preferences or game location
    setState(() {
      defaultLocationName = 'Home Field';
      defaultLocationAddress = '123 Main St, Anytown, IL';
    });
  }
        ...
        Expanded(
          child: OutlinedButton(
            ...
            style: OutlinedButton.styleFrom(
              ...
              side: const BorderSide(color: AppColors.efficialsWhite),
