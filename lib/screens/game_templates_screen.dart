...
class _GameTemplatesScreenState extends State<GameTemplatesScreen> {
  ...
  void _showTemplateSelectionDialog(
      String sport, List<GameTemplateModel> sportTemplates) {
    showDialog(
      context: context,
  ...
  Widget _buildDialogTemplateCard(
      GameTemplateModel template, StateSetter setDialogState) {
                        ...
                        child: TextButton(
                          onPressed: () async {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                  content: Text('Edit template coming soon!')),
                            );
                          },
                          style: TextButton.styleFrom(
  ...
  Widget _buildSportCard(String sport, List<GameTemplateModel> sportTemplates) {
    final theme = Theme.of(context);
    final colorScheme = theme.colorScheme;
    ...
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          _showTemplateSelectionDialog(sport, sportTemplates);
        },
        child: Container(
          padding: const EdgeInsets.all(16),
          decoration: BoxDecoration(
