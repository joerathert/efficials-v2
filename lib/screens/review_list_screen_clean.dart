...
class _ReviewListScreenState extends State<ReviewListScreen> {
  ...
  void _confirmList() {
    final selectedOfficialsData = selectedOfficialsList
        .where((official) => selectedOfficials[official['id'] as String] ?? false)
        .toList();

    Navigator.pop(context, {
      'selectedOfficials': selectedOfficialsData,
      'listName': listName,
      'sport': sport,
    });
  }
                                    ...
                                    Checkbox(
                                      value: filteredOfficials.isNotEmpty &&
                                          filteredOfficials.every((official) =>
                                              selectedOfficials[official['id'] as String] ?? false),
                                      onChanged: (bool? value) {
                                        setState(() {
                                          if (value == true) {
                                            for (final official in filteredOfficials) {
                                              selectedOfficials[official['id'] as String] = true;
                                            }
                                          } else {
                                            for (final official in filteredOfficials) {
                                              selectedOfficials.remove(official['id'] as String);
                                            }
                                          }
                                        });
                                      },
                                  ...
                                  child: ConstrainedBox(
                                    ...
                                    child: Container(
                                      ...
                                      child: ListTile(
                                        ...
                                        onTap: () {
                                          setState(() {
                                            final currentValue = selectedOfficials[officialId] ?? false;
